...
/**
 * AI Addons Site Title
 *
 * @since 1.0.0
 */
 
class AIEA_Elementor_Site_Title_Widget extends Widget_Base {
	
	/**
	 * Get widget name.
	 *
	 * Retrieve Site Title name.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_name() {
		return 'ai-site-title';
	}

	/**
	 * Get widget title.
	 *
	 * Retrieve Site Title title.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_title() {
		return __( 'Site Title ', 'ai-addons' );
	}

	/**
	 * Get widget icon.
	 *
	 * Retrieve Site Title icon.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_icon() {
		return 'ai-default-icon '. aiea_addon_base()->widget_icon_classes('site-title');
	}
	 ...
	 *
	 * Retrieve the list of categories the Site Title widget belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_keywords() {
		return [ 'title', 'site title', 'wp title', 'blog title' ];
	}
			
	public function get_help_url() {
        return 'https://aiaddons.ai/ai-site-title/';
    }

	/**
	 * Register Site Title widget controls. 
	 *
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'aiea_section',
			[
				'label'	=> esc_html__( 'Site Title ', 'ai-addons' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ai-site-title' => 'text-transform: {{VALUE}};'
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ai-site-title' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' 		=> '',
				'selectors' => [
					'{{WRAPPER}} .ai-site-title' => 'color: {{VALUE}};'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' 		=> '',
				'selectors' => [
					'{{WRAPPER}} .ai-site-title:hover' => 'color: {{VALUE}};'
				],
			]
		);		
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ai-site-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);		
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .ai-site-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' 		=> '{{WRAPPER}} .ai-site-title'
			]
		);
		$this->add_control(
			'text_shadow_opt',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{SELECTOR}} .ai-site-title' => 'text-shadow: {{HORIZONTAL}}px {{VERTICAL}}px {{BLUR}}px {{COLOR}};',
				],
			]
		);
		$this->end_controls_section();
	...
	/**
	 * Render Site Title widget output on the frontend.
	 *
	...
	protected function render() {
		...
		echo '<div class="ai-site-title-wrapper">';			
				echo '<'. esc_attr( $title_tag ) .' class="ai-site-title">'. get_bloginfo( 'name' ) .'</'. esc_attr( $title_tag ) .'><!-- .ai-site-title -->';
