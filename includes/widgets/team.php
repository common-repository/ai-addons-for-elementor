...
class AIEA_Elementor_Team_Widget extends Widget_Base {
	...
	public function get_icon() {
		return 'ai-default-icon '. aiea_addon_base()->widget_icon_classes('team');
	}
	...
	public function get_keywords() {
		return [ 'team', 'member', 'user', 'employee', 'staff', 'profile' ];
	}
		
	public function get_help_url() {
        return 'https://aiaddons.ai/team-demo/';
    }
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'		=> 'layout-1',
				'choices'		=> [
					'layout-1'		=> [ 'thumbnail' => AIEA_URL .'assets/images/layouts/team/layout-1.jpg', 'image' => 'https://aiaddons.ai/ai-import/widget-layouts/team/layout-1.jpg', 'label' => esc_html__( 'Layout 1', 'ai-addons' ) ],
					'layout-2'		=> [ 'thumbnail' => AIEA_URL .'assets/images/layouts/team/layout-2.jpg', 'image' => 'https://aiaddons.ai/ai-import/widget-layouts/team/layout-2.jpg', 'label' => esc_html__( 'Layout 2', 'ai-addons' ) ],
					'layout-3'		=> [ 'thumbnail' => AIEA_URL .'assets/images/layouts/team/layout-3.jpg', 'image' => 'https://aiaddons.ai/ai-import/widget-layouts/team/layout-3.jpg', 'label' => esc_html__( 'Layout 3(Pro)', 'ai-addons' ) ],
					'layout-4'		=> [ 'thumbnail' => AIEA_URL .'assets/images/layouts/team/layout-4.jpg', 'image' => 'https://aiaddons.ai/ai-import/widget-layouts/team/layout-4.jpg', 'label' => esc_html__( 'Layout 4(Pro)', 'ai-addons' ) ],
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'team_layout!' => $this->get_free_options('team_layout'),
				]
			]
		);
		...
		$this->start_controls_section(
			...
			[
				...
				'tab'			=> Controls_Manager::TAB_CONTENT,
				'condition' 	=> [ 'team_layout' => 'layout-2'],
			]
		);
		$this->add_control(
			'overlay_enable',
			[
				'label' 		=> esc_html__( 'Overlay Enable', 'ai-addons' ),
				'type' 			=> Controls_Manager::SWITCHER,
				'default' 		=> 'yes',
				'prefix_class' => 'team-overlay-'	
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'label' 		=> esc_html__( 'Name', 'ai-addons' ),
				'default' 		=>  esc_html__( 'Member', 'ai-addons' )
			]
		);		
		$this->add_control(
			'title_head',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .team-wrapper .team-title' => 'text-transform: {{VALUE}};'
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				'type'			=> Controls_Manager::TEXT,
				'label' 		=> esc_html__( 'Name', 'ai-addons' ),
				'default' 		=>  esc_html__( 'CEO', 'ai-addons' )
			]
		);		
		$this->add_control(
			'des_head',
		...
		$this->add_control(
			'image_position_trigger',
			[
				'label' => esc_html__( 'Image Position Trigger', 'ai-addons' ),
				'type' => 'ai-trigger',
				'default' => 'nothing',
		...
		$this->start_controls_section(
			'icons_section',
			[
				'label'			=> esc_html__( 'Social Icons', 'ai-addons' ),
				'tab'			=> Controls_Manager::TAB_CONTENT
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				...
				'tab'			=> Controls_Manager::TAB_CONTENT,
				'condition' 	=> [ 'team_layout' => 'layout-1'],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label'			=> esc_html__( 'Content', 'ai-addons' ),
				'default' 		=> aiea_addon_base()->make_default_content('team'),
			]
		);
		$this->end_controls_section();	
		...
		$this->start_controls_section(
			'section_style_team',
			[
				'label' => __( 'Team', 'ai-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,				
			]
		);
		
		$this->start_controls_tabs( 'team_content_styles' );
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .team-inner *' => 'text-align: {{VALUE}};',
				]
			]
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .team-inner > *' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .team-inner > *' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .team-inner > *' => 'box-shadow: {{HORIZONTAL}}px {{VERTICAL}}px {{BLUR}}px {{SPREAD}}px {{COLOR}} {{icon_box_shadow_pos.VALUE}};',
				]
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .team-inner:hover > *' => 'box-shadow: {{HORIZONTAL}}px {{VERTICAL}}px {{BLUR}}px {{SPREAD}}px {{COLOR}} {{icon_box_hbox_shadow_pos.VALUE}};',
				]
			]
		);
		$this->add_control(
			'team_hbox_shadow_pos',
			[
				'label' =>  esc_html__( 'Box Shadow Position', 'ai-addons' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .ai-team-img:after' => 'background-color: {{VALUE}};'
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .ai-team-img:after' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);		
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ai-team-img:after' => 'opacity: calc( {{SIZE}} / 10 );'
				]
			]
		);
		$this->add_responsive_control(
			'overlay_content_pos',
			[
				'label' => esc_html__( 'Overlay Content Position', 'ai-addons' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
				...
				'selectors' => [
					'{{WRAPPER}} .team-inner:hover .team-overlay-wrapper .team-overlay-inner' => 'top: {{SIZE}}%;',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'default' 		=> '',
				'selectors' => [
					'{{WRAPPER}}:hover .team-title' => 'color: {{VALUE}};'
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'default' 		=> '',
				'selectors' => [
					'{{WRAPPER}} .team-member-des' => 'color: {{VALUE}};'
				],
			]
		);	
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'default' 		=> '',
				'selectors' => [
					'{{WRAPPER}}:hover .team-member-des' => 'color: {{VALUE}};'
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .team-member-des' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' 		=> '{{WRAPPER}} .team-member-des'
			]
		);	
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ai-team-img > img' => 'width: {{SIZE}}px;',
				],
			]
		);	
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ai-team-img > img' => 'height: {{SIZE}}px;',
				],
			]
		);	
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .ai-team-img > img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);		
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .ai-team-img > img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		$this->add_group_control(
			Group_Control_Border::get_type(),
				[
					...
					'selector' => '{{WRAPPER}} .ai-team-img > img'
				]
		);
		$this->add_responsive_control(
			'image_border_radius',
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .ai-team-img > img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		$this->end_controls_section();		
		...
		$this->add_control(
			...
			[
				...
				'default' 		=> '',
				'selectors' => [
					'{{WRAPPER}} .team-content, {{WRAPPER}} .team-content a' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .ai-social-icons > li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		$parent_class = isset( $layout ) ? 'team-' . $layout : 'team-default';
		$this->add_render_attribute( 'ai-widget-wrapper', 'class', 'team-elementor-widget team-wrapper' );
		...
		$des_head = isset( $des_head ) && $des_head != '' ? $des_head : 'h5';
		
		//Content Section
		$this->team_content = isset( $content ) && $content != '' ? $content : ''; 
		...
		if ( ! empty( $settings['image']['url'] ) ) {
			...
			$image_html = '<figure class="ai-team-img">' . $image . '</figure>';
			
			if( ( isset( $section_image_enabled ) && $section_image_enabled == 'yes' ) && ( isset( $overlay_enable ) && $overlay_enable == 'yes' ) ) {
				$oelemetns = isset( $overlay_items ) && !empty( $overlay_items ) ? json_decode( $overlay_items, true ) : array( 'visible' => [] );
				if( !empty( $oelemetns ) && isset( $oelemetns['visible'] ) ) {
					$overlay_elements = $oelemetns['visible'];
					if( !empty( $overlay_elements ) ) {
						$image_html .= '<div class="team-overlay-wrapper">';
							ob_start();
							echo '<div class="team-overlay-inner">';
							foreach( $overlay_elements as $element => $value ){
								$this->aiea_team_shortcode_elements( $element );
							}
							echo '</div>';
		...
		//Layout
		$team_layout = isset( $team_layout ) && $team_layout != '' ? $team_layout : 'layout-1'; 

		echo '<div class="team-inner">';
			$layouts = $this->get_free_options('team_layout');
			if( !in_array( $team_layout, $layouts ) ) {
				$team_layout = 'layout-1';
			}
			$layout_fun_name = 'aiea_team_'. str_replace( "-", "_", $team_layout ); 
			$this->$layout_fun_name($team_layout);
		echo '</div><!-- .team-inner -->';
		
		echo '</div> <!-- .ai-widget-wrapper -->';
	}
	
	function aiea_team_layout_1( $team_layout ) {
		echo '<div class="aiea-team-'. esc_attr( $team_layout ) .'">';
			echo '<div class="aiea-team-image">';
					$this->aiea_team_shortcode_elements("image");
			echo '</div>';
			echo '<div class="aiea-team-header">';
				echo '<div class="aiea-team-header-body">';
					// name
					$this->aiea_team_shortcode_elements("name");
					// designation
					$this->aiea_team_shortcode_elements("des");
				echo '</div>';
			echo '</div>';
			echo '<div class="aiea-team-content">';
				$this->aiea_team_shortcode_elements("content");
			echo '</div>';
			echo '<div class="aiea-team-social-icons">';
				$this->aiea_team_shortcode_elements("social");
			echo '</div>';			
		echo '</div> <!-- aiea-team-layout-1 -->';
	}
	
	function aiea_team_layout_2( $team_layout ) {
		echo '<div class="aiea-team-'. esc_attr( $team_layout ) .'">';
			echo '<div class="aiea-team-image">';
					$this->aiea_team_shortcode_elements("image");
			echo '</div>';
			echo '<div class="team-overlay-wrapper">';
				echo '<div class="team-overlay-inner">';
					echo '<div class="aiea-team-header">';
						echo '<div class="aiea-team-header-body">';
							// name
				...
				echo '</div>';	
			echo '</div>';	
		echo '</div> <!-- aiea-team-layout-2 -->';
	}
	
	function aiea_team_shortcode_elements( $element ){
		...
		switch( $element ){
			...
			case "name":
				...
				if( $title_array['title'] ){
					echo '<'. esc_attr( $title_array['title_head'] ) .' class="team-title">'. esc_html( $title_array['title'] ) .'</'. esc_attr( $title_array['title_head'] ) .'>';
				}
			break;
			
			case "image":
				echo $this->team_array['img_html'];
			break;
			...
			case "des":
				...
				$des_head = isset( $settings['des_head'] ) ? $settings['des_head'] : 'h5';
				
				if( $designation ) {
					echo '<'. esc_attr( $des_head ) .' class="team-member-des">'. esc_html( $designation ) .'</'. esc_attr( $des_head ) .'>';
				}
				
			break;
						
			case "content":
				if( $this->team_content ) echo '<div class="team-content">'. $this->team_content .'</div>';
			break;
