 ...
 *
 */
class AIEA_Themify_Icon_Control extends Base_Data_Control {
	...
	public function enqueue() {
		wp_register_style( 'themify-icons', AIEA_URL . 'assets/css/front-end/themify-icons.css', false, '1.0' );
	...
	public static function get_icons() {
		...
		$menu_ico = aiea_addon_base()->themify_icons();
		$themify_array = array();
		if( $menu_ico ){
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select id="<?php echo esc_attr( $control_uid ); ?>" class="elementor-control-ti-icon" data-setting="{{ data.name }}" data-placeholder="<?php echo __( 'Select Icon', 'ai-addons' ); ?>" style="font-family: 'themify';">
